...
datos_parametros = {"Departamento":["H","A",""],"Municipio":["I","B",""],"Nombre_fuente":["R","C",""],"Codigo_punto":["O","E",""],"Fecha":["M","F",""],"Hora":["N","G",""],"Hora_caudal":["BI","G",""]}
datos_parametros_2 = {"pH":["AO","K",""],"Temperatura":["AP","K",""],"OD":["AS","K",""],"Conductividad_E":["AY","K",""],"Caudal":["BH","K",""]}
datos_parametros_2_type = {"pH":"str","Temperatura":"str","OD":"str","Conductividad_E":"str","Caudal":"str"}
nombre = "\Informe_SUB_llenado"
